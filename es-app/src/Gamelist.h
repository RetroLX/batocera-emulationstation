...
std::vector<FileData*> loadGamelistFile(const std::string xmlpath, SystemData* system, parallel_flat_hash_map<std::string, FileData*>& fileMap, size_t checkSize = SIZE_MAX, bool fromFile = true);
