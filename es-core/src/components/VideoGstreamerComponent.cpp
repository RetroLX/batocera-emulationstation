...
libvlc_instance_t* VideoGstreamerComponent::mVLC = NULL;
...
void VideoGstreamerComponent::setupContext()
{
	if (mContext.valid)
		return;
...
void VideoGstreamerComponent::freeContext()
{
	if (!mContext.valid)
		return;
...
void VideoGstreamerComponent::setupVLC(std::string subtitles)
{
	if (mVLC != nullptr)
		return;
